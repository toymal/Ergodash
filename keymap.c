...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX,             LOWER,   KC_SPC ,KC_DEL,         KC_BSPC,KC_ENT , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
 ...
 /* Raise
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,           XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, RAISE,          KC_KP_0, KC_PDOT, KC_PENT, KC_PENT  \
  ),
